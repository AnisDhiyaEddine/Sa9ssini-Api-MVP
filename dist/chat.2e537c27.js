...
},{"./debug":"node_modules/socket.io-parser/node_modules/debug/src/debug.js","process":"../../../../../.config/yarn/global/node_modules/process/browser.js"}],"node_modules/socket.io-parser/node_modules/component-emitter/index.js":[function(require,module,exports) {
...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"src/scripts/chat/chat.js":[function(require,module,exports) {
...
var UIController = function UIController() {
  ...
  var getMsgInput = function getMsgInput() {
    return DOMStrings.messageInput.value;
  };

  var displayMsg = function displayMsg(html) {
  ...
  var formatBtn = function formatBtn() {
...
var APPController = function APPController() {
  var UICtrl = UIController();
  var ModelCtrl = ModelController(); //listen for incoming messages

  ModelCtrl.listenIncMsg(UICtrl.Templates.messageRecievedTemplate); //Send message     --fronties improvments

  UICtrl.DOMStrings.messageForm.addEventListener("submit", function (e) {
    e.preventDefault();
    ModelCtrl.sendMsg(UICtrl.getMsgInput(), UICtrl.Templates.messageSentTemplate);
  }); //share location

  UICtrl.DOMStrings.locationButton.addEventListener("click", function (e) {
    e.preventDefault();
    ModelCtrl.shareLocation(UICtrl.Templates.locationSentTemplate);
  }); //listen for incoming location share

  ModelCtrl.listenLocation(UICtrl.Templates.locationRecievedTemplate); //Join a chat room
...
var ModelController = function ModelController() {
  ...
  var listenIncMsg = function listenIncMsg(template) {
  ...
  var sendMsg = function sendMsg(input, template) {
    socket.emit("sendMessage", input, function () {
      var html = Mustache.render(template, {
        message: input,
        createdAt: moment(input.createdAt).format("h:mm a")
      });
  ...
  var shareLocation = function shareLocation(template) {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
      socket.emit("sendLocation", {
        ...
        var html = Mustache.render(template, {
          url: "https://google.com/maps?q=".concat(position.coords.latitude, ",").concat(position.coords.longitude),
  ...
  var listenLocation = function listenLocation(template) {
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/scripts/chat/chat.js"], null)
//# sourceMappingURL=/chat.2e537c27.js.map